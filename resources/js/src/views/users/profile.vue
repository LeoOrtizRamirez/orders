                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex flex-col justify-center items-center">
                            <img :src="authStore.user?.image ? '/storage/' + authStore.user.image : '/assets/images/profile-34.jpeg'" alt="" class="w-24 h-24 rounded-full object-cover mb-5" />
                            <p class="font-semibold text-primary text-xl">{{ authStore.user?.name || 'Usuario' }}</p>
                        </div>
                        <ul class="mt-5 flex flex-col max-w-[160px] m-auto space-y-4 font-semibold text-white-dark">
                            <li>
                                <a href="javascript:;" class="flex items-center gap-2">
                                    ...
                                    <span class="text-primary truncate">{{ authStore.user?.email || 'user@example.com' }}</span></a
                                >
                            </li>
