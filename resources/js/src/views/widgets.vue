    ...
    <div>
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-6">
            ...
            <div class="panel h-full p-0 border-0 overflow-hidden">
                <div class="p-6 bg-gradient-to-r from-[#194C8D] to-[#160f6b] min-h-[190px]">
            ...
            <div class="panel h-full">
                ...
                <div class="flex items-center justify-between">
                    <div class="w-full rounded-full h-5 p-1 bg-dark-light overflow-hidden shadow-3xl dark:shadow-none dark:bg-dark-light/10">
                        <div
                            class="bg-gradient-to-r from-[#194C8D] to-[#805dca] w-full h-full rounded-full relative before:absolute before:inset-y-0 ltr:before:right-0.5 rtl:before:left-0.5 before:bg-white before:w-2 before:h-2 before:rounded-full before:m-auto"
                            style="width: 65%"
                        ></div>
                    </div>
            ...
            >
                <div class="flex items-start justify-between text-white-light mb-16 z-[7]">
                    ...
                    <div class="relative text-xl whitespace-nowrap">
                        $ 41,741.42
                        <span class="table text-[#d3d3d3] bg-[#194C8D] rounded p-1 text-xs mt-1 ltr:ml-auto rtl:mr-auto">+ 2453</span>
                    </div>
                </div>
                <div class="flex items-center justify-between z-10">
                    ...
                    <a href="javascript:;" class="shadow-[0_0_2px_0_#bfc9d4] rounded p-1 text-white-light hover:bg-[#194C8D] z-10"> Upgrade </a>
                </div>
            </div>
        </div>
            ...
            <div class="panel h-full">
                <div class="flex items-start border-b border-[#e0e6ed] dark:border-[#1b2e4b] -m-5 mb-5 p-5">
                    <div class="shrink-0 ring-2 ring-white-light dark:ring-dark rounded-full ltr:mr-4 rtl:ml-4">
                        <img src="/assets/images/profile-34.jpeg" alt="" class="w-10 h-10 rounded-full object-cover" />
                    </div>
