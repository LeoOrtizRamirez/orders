                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        ...
                        <form class="space-y-5 dark:text-white" @submit.prevent="handleRegister">
                            <div v-if="errorMessage" class="bg-red-500 text-white p-3 rounded">
                                {{ errorMessage }}
                            </div>
                            <div v-if="successMessage" class="bg-green-500 text-white p-3 rounded">
                                {{ successMessage }}
                            </div>
                            <div>
                            ...
                            <div>
                                <label class="flex cursor-pointer items-center">
                                    <input type="checkbox" class="form-checkbox bg-white dark:bg-black" v-model="form.newsletter" />
                                ...
                                <li>
                                    ...
                                    >
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            ...
                                            />
                                            <path
                                                d="M7.13089 4.2375C5.9 4.2375 4.2375 5.9 4.2375 8C4.2375 10.1 5.9 11.7625 7.13089 11.7625C8.36178 11.7625 10.0243 10.1 10.0243 8C10.0243 5.9 8.36178 4.2375 7.13089 4.2375ZM7.13089 10.45C6.6875 10.45 5.55 9.4 5.55 8C5.55 6.6875 6.6 5.55 7.13089 5.55C7.66178 5.55 8.71178 6.6 8.71178 8C8.71178 9.3125 7.66178 10.45 7.13089 10.45Z"
                                                fill="white"
                                            />
                                            <path
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            if (response.status === 201 || response.status === 200) {
                ...
                // You can automatically log the user in or redirect to login
                setTimeout(() => {
