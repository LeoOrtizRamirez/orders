<template>
    <div class="flex items-center justify-between flex-wrap gap-4">
        <h2 class="text-xl">{{ $t('suppliers_page.title') }}</h2>
        <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
            <div class="flex gap-3">
                <!-- Botón Agregar -->
                <div>
                    <button 
                        v-if="authStore.can('create suppliers')"
                        type="button" 
                    ...
                    >
                        ...
                        {{ $t('suppliers_page.add_supplier_btn') }}
                    </button>
                </div>
            ...
            <div class="flex gap-2">
                ...
                >
                    <option value="">{{ $t('suppliers_page.filters.all_status') }}</option>
                    <option value="1">{{ $t('suppliers_page.filters.active') }}</option>
                    <option value="0">{{ $t('suppliers_page.filters.inactive') }}</option>
                </select>
            </div>
            ...
            <div class="relative">
                <input
                    ...
                    @input="$emit('update:search-supplier', ($event.target as HTMLInputElement).value)"
                />
...
<script lang="ts" setup>
    ...
    interface Emits {
        ...
        (e: 'update:search-supplier', value: string): void;
        (e: 'add-supplier'): void;
    }
