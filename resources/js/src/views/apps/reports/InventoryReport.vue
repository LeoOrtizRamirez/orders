            ...
            <div class="panel">
                <div class="flex flex-col md:flex-row items-center justify-between mb-4 gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <!-- Botón Exportar -->
                        <button type="button" class="btn btn-success gap-2" @click="exportToExcel">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M12 15L12 2M12 15L9 11M12 15L15 11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                            Exportar
                        </button>
                    </div>
...
const exportToExcel = async () => {
    try {
        ...
        if (filters.value.unit) params.append('unit', filters.value.unit);
        if (filters.value.stockStatus) params.append('stock_status', filters.value.stockStatus);
        ...
        alert('No se pudo exportar el inventario. Por favor, intente de nuevo.');
    }
};
