                ...
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="relative">
                            ...
                            >
                                <li>
                                    <router-link to="/apps/manage-roles/roles-list">{{ $t('list') }}</router-link>
                                </li>
                                <li>
                                    <router-link to="/apps/manage-roles/permissions-list">{{ $t('preview') }}</router-link>
                                </li>
                                <li>
                                    <router-link to="/apps/manage-roles/roles-permissions-list">{{ $t('add') }}</router-link>
                                </li>
                            </ul>
                        </li>
                        <li>
