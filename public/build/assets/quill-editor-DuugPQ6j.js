import{c as h,_ as m}from"./codePreview-D3lNCkU-.js";import{q as p}from"./vue3-quill-DfBt4LpA.js";import{u as C}from"./main-Dt_U_J2X.js";import{d as x,r,k as w,l as a,m as t,C as s,P as d,x as v,u as i,f as b,q as f}from"./vendor-BuRU_kNN.js";import"./quill-De1S0mUZ.js";const k={class:"pt-5 space-y-8"},P={class:"grid grid-cols-1 lg:grid-cols-2 gap-6"},V={class:"panel"},A={class:"flex items-center justify-between mb-5"},M={class:"mb-5"},y={class:"panel"},N={class:"flex items-center justify-between mb-5"},S={class:"mb-5"},_=x({__name:"quill-editor",setup(L){C({title:"Quill Editor"});const{codeArr:l,toggleCode:n}=h(),q=r({modules:{toolbar:[[{header:[1,2,!1]}],["bold","italic","underline","link"],[{list:"ordered"},{list:"bullet"}],["clean"]]},placeholder:""}),o=r(`<h1>This is a heading text...</h1>
            <br />
            <p>
